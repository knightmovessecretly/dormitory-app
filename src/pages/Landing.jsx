  ...
  />
      ...
      <div className="grid grid-cols-[1fr_2fr] grid-rows-2 gap-4 p-6 bg-white h-[600px]">
        <img
          ...
          className="w-full h-full rounded-lg shadow-md object-cover vignette cursor-pointer transition-transform hover:scale-105"
        />
        ...
        <img
          ...
          className="row-span-2 w-full h-full rounded-lg shadow-md object-cover vignette cursor-pointer transition-transform hover:scale-105"
        />
        <img
          src={images[1].src}
          alt={images[1].alt}
